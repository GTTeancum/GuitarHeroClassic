...
int main() {
  ...
  ok &= contains(gameplay_c,
                 ...
                 "camera_manager_findshot_disabled_gate,"
                 "camera_manager_shotmatches_filters,",
                 "camera implementation status keeps worldbase downbeat duration and script filters before MakeCategoryAndFilters, NumCameraShots, and the CameraManager FirstShotOk/Disabled/ShotMatches scan");
  ok &= contains(gameplay_c,
                 "camera_manager_first_shot_ok_hook,"
                 "camera_manager_findshot_disabled_gate,"
                 "camera_manager_shotmatches_filters,"
