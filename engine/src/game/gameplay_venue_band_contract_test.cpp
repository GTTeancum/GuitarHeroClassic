...
int main() {
  ...
  ok &= contains(hud_renderer_c,
                 ...
                 "star-power tube-meter glow remaps the source texture over the filled thick body");
  ok &= contains(hud_renderer_c,
  ...
  ok &= contains(hud_renderer_c,
                 ...
                 "star-power tube-meter glow uses the original source texture across the currently filled body");
  ok &= contains(hud_renderer_c,
                 "tube_meter_range,true",
                 "star-power tube-meter glow remaps only the source amp_tube_glow_meter layer, not the persistent path line");
  ok &= contains(hud_renderer_c,
