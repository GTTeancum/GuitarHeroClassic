...
def main() -> int:
    root = Path("engine/out/visual_proofs/lower_body_2p_select_context_animate_20260715")
    cases = make_cases()
    try:
        require(
